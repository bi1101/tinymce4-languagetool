...
var LanguageTool = function LanguageTool(lt_set, $) {
                            ...
                            func: function () {
                                ...
                                for (var i = 0; i < tlen; i++) {
                                    ...
                                    if (uuid != undefined && sgstore['ignore']['all'][tempword] == undefined && (sgstore['ignore']['once'][uuid] == undefined || sgstore['ignore']['once'][uuid][tempword] == undefined)) {
                                        ...
                                        lt_applyHighlighter(sgstore['obj'][uuid], i, tempword, item['rule']['id'], hclass, item['offset'], item['offset'] + item['length'], item['replacements']);
                                        locklist[uuid] = 1;
    ...
    function lt_applyHighlighter(myobj, myid, myword, myrule, myclass, mystart, myend, suggestions) {
        var alist = {};
        ...
        suggestions.forEach(function (suggestion) {
            ...
            // Add more attributes or event listeners to listItem if needed
