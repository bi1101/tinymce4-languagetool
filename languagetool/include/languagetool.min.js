...
var LanguageTool = function LanguageTool(lt_set, $) {
    ...
    function processSuccessRequest(data) {
        // Queue a new task into the sgstore['run'] array
        sgstore['run'].push({
            data: data,
            ...
            func: function () {
                ...
                console.log('Before clear highlight');
                ...
                console.log('After clear highlight');
                ...
                for (var i = 0; i < tlen; i++) {
                    // Extract the current match from the 'matches' array in the response data
                    var item = json['matches'][i];

                    // Initialize the highlight class as 'other'. This will be used to style the highlight for this match
                    var hclass = lt_setHighlight['other'];

                    // Determine the highlight class based on the issue type
                    if (lt_setHighlight[item['rule']['issueType']] != undefined) {
                        hclass = lt_setHighlight[item['rule']['issueType']];
                    }

                    // Extract the relevant substring from mytext
